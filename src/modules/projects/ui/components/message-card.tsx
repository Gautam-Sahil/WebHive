...
const AssistantMessage = ({
    ...
    return (
        ...
        />
          <span className="text-sm font-medium">WebHive</span>
          <span className="text-xs text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100"> {format(createdAt, "HH:mm 'on' MMM dd, yyyy")}
